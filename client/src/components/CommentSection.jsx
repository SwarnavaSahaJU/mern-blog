      ...
      {currentUser && (
        ...
        >
          ...
          <div className="flex justify-between items-center mt-5">
            ...
            > */}
            <div className="p-[2px] rounded-md bg-gradient-to-r from-purple-500 to-blue-500 inline-block">
              <Button
                type="submit"
                className="bg-white text-white bg-clip-text bg-gradient-to-r from-purple-500 to-blue-500 
               w-full rounded-md hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-500 
